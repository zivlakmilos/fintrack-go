...
func InitDB(db *sql.DB) error {
	...
	err = execQuery(db, "CREATE TABLE IF NOT EXISTS records (id TEXT PRIMARY KEY, accountId TEXT, recordId TEXT, debit REAL, credit REAL, description TEXT, date TEXT)")
	if err != nil {
		return err
	}
